...
```{r CV_mod1_hour}
form1_hour = rateCar ~ hour_groups * rateCar_LaggedHour - hour_groups - rateCar_LaggedHour + s(hour, bs="cc", by=weekendsIndicator)
...
2. **weekdays** : 
```{r CV_mod1_wd}
form1_weekdays = rateCar ~ hour_groups * rateCar_LaggedHour - hour_groups - rateCar_LaggedHour + s(weekdays, bs="cc", k = 4, by=winterHolidaysIndicator) 
