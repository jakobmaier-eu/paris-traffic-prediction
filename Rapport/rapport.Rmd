...
Commençons par la tâche la plus simple : prédire la circulation de l'heure suivante. On présente les différents types de modèle construits. Pour chacun, on construit un modèle avec et sans arêtes voisines, afin d'observer si ces dernières fournissent de l'information que le modèle convertit en une meilleure prédiction. 
