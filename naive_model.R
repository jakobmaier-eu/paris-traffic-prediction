...
# Naive Prediction (3)
naivePrediction3 <- naiveModelBis(F3)
...
pred2 = readRDS("data/naivePrediction2.rds")
pred3 = readRDS("data/naivePrediction3.rds")
...
# save(rmse_list_naivePrediction2, mape_list_naivePrediction2, file = "naivePrediction2.RData")
