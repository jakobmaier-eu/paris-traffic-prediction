...
neigh_before[[i]] = c("porte italie - pont amont", "porte de vincennes - pont amont")
...
neigh_after[[i]] = c("pont amont - porte italie", "pont amont - porte de vincennes")
...
edges[[i]] = c(7175, 4418)
neigh_after[[i]] = c("porte asnieres - porte de la chapelle", "porte asnieres - porte maillot")
...
neigh_before[[i]] = c("porte de la chapelle - porte asnieres", "porte maillot - porte asnieres")
...
neigh_after[[i]] = c("bastille - porte de vincennes", "bastille - strasbourg saint denis")
...
neigh_after[[i]] = c("porte de la chapelle - bagnolet", "porte de la chapelle - porte asnieres")
...
neigh_before[[i]] = c("bagnolet - porte de la chapelle", "porte asnieres - porte de la chapelle")
...
neigh_before[[i]] = c("saint lazare - strasbourg saint denis", "porte de la chapelle - strasbourg saint denis")
...
neigh_before[[i]] = c("porte de vincennes - bastille", "strasbourg saint denis - bastille", "pont austerlitz - bastille")
...
neigh_after[[i]] = c("strasbourg saint denis - saint lazare", "strasbourg saint denis - porte de la chapelle")
...
neigh_after[[i]] = c("strasbourg saint denis - bastille", "strasbourg saint denis - porte de la chapelle", "strasbourg saint denis - chatelet")
...
neigh_before[[i]] = c("bastille - strasbourg saint denis", "porte de la chapelle - strasbourg saint denis", "chatelet - strasbourg saint denis")
...
neigh_after[[i]] = c("pont austerlitz - place italie", "pont austerlitz - pont amont")
neigh_before[[i]] = c("porte de vincennes - bastille", "strasbourg saint denis - bastille")
...
neigh_before[[i]] = c("pont amont - porte de vincennes", "bagnolet - porte de vincennes")
...
neigh_after[[i]] = c("porte de vincennes - pont amont", "porte de vincennes - bagnolet")
...
neigh_after[[i]] = c("strasbourg saint denis - saint lazare", "strasbourg saint denis - porte de la chapelle")
neigh_before[[i]] = c("porte de vincennes - bastille", "pont austerlitz - bastille", "jussieu - bastille")
...
neigh_after[[i]] = c("bastille - porte de vincennes", "bastille - pont austerlitz", "bastille - chatelet")
neigh_before[[i]] = c("saint lazare - strasbourg saint denis", "porte de la chapelle - strasbourg saint denis")
...
a=c("PE_Haubans")
edges[[i]] = c(5279)
neigh_after[[i]] = c("pont amont - pont austerlitz", "pont amont - porte de vincennes")
...
neigh_before[[i]] = c("pont austerlitz - pont amont", "porte de vincennes - pont amont")


#pont amont - porte de vincennes
i = 58
names(edges)[i] = "pont amont - porte de vincennes"
a=c("PE_Reuilly")
edges[[i]] = c(5325)
neigh_after[[i]] = c("porte de vincennes - bastille", "porte de vincennes - bagnolet")
neigh_before[[i]] = c("pont austerlitz - pont amont", "porte italie - pont amont")



#porte de vincennes - pont amont
i = 59
names(edges)[i] = "porte de vincennes - pont amont"
a=c("PI_Reuilly")
edges[[i]] = c(5338)
neigh_after[[i]] = c("pont amont - pont austerlitz", "pont amont - porte italie")
neigh_before[[i]] = c("bastille - porte de vincennes", "bagnolet - porte de vincennes")



#porte de vincennes - bagnolet
i = 60
names(edges)[i] = "porte de vincennes - bagnolet"
a=c("PE_Louis_Lumiere") # et autres!
edges[[i]] = c(5347, 5330, 5331, 5347, 5350, 5351)
neigh_after[[i]] = c("bagnolet - porte de la chapelle")
neigh_before[[i]] = c("bastille - porte de vincennes", "pont amont - porte de vincennes")


#bagnolet - porte de vincennes
i = 61
names(edges)[i] = "bagnolet - porte de vincennes"
a=c("PI_Louis_Lumiere")
edges[[i]] = c(5360)
neigh_after[[i]] = c("porte de vincennes - bastille", "porte de vincennes - pont amont")
neigh_before[[i]] = c("porte de la chapelle - bagnolet")
...
edges[[i]] = c(5363, 5369)
neigh_after[[i]] = c("porte de la chapelle - strasbourg saint denis", "porte de la chapelle - porte asnieres")
neigh_before[[i]] = c("porte de vincennes - bagnolet")
...
edges[[i]] = c(5387, 5380)
neigh_after[[i]] = c("bagnolet - porte de vincennes")
neigh_before[[i]] = c("strasbourg saint denis - porte de la chapelle", "porte asnieres - porte de la chapelle")
...
neigh_before[[i]] = c("strasbourg saint denis - porte de la chapelle", "bagnolet - porte de la chapelle")
...
edges[[i]] = c(5411, 5395)
neigh_after[[i]] = c("porte de la chapelle - strasbourg saint denis", "porte de la chapelle - bagnolet")
...
neigh_before[[i]] = c("saint lazare - porte asnieres", "porte de la chapelle - porte asnieres")
...
a=c("PI_Champerret")
edges[[i]] = c(5419)
neigh_after[[i]] = c("porte asnieres - rond point etoile", "porte asnieres - saint lazare", "porte asnieres - porte de la chapelle")
